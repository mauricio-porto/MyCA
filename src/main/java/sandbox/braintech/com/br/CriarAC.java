...
public class CriarAC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        saveToKeystore(acCert, acKeyPair.getPrivate(), "acdeliverit.jks", "JKS");
        saveToFile(acCert, "deliverit.cer");
    ...
    static X509Certificate createAcCert(String subject, BigInteger serialNumber, int validityInDays, KeyPair keyPair) throws Exception {
        ...
        PolicyQualifierInfo pqInfo = new PolicyQualifierInfo("http://www.deliverit.com.br");
